    ...
    for ars in arss:
        for y in ars[1:]:
            ...
            if width_type==3:
                ...
                lw=lws[0]
            sclog=option['scale_log']
            if sclog==None:
                ax.plot(ars[0][0],y[0],linewidth=lw,linestyle='-',label=label)
            elif sclog=='logy':
                ax.semilogy(ars[0][0],y[0],linewidth=lw,linestyle='-',label=label)
            elif sclog=='logx':
                ax.semilogx(ars[0][0],y[0],linewidth=lw,linestyle='-',label=label)
            elif sclog=='logxy':
                ax.loglog(ars[0][0],y[0],linewidth=lw,linestyle='-',label=label)
            ploted+=1
    plt.legend()
